...
export default function App() {
  ...
  const data = [
    {
      title: "Early Stages",
      subtitle: "Physical Self's Starting Point",
      color: "text-cyan-400",
      borderColor: "border-cyan-500/50",
      icon: Cylinder,
      bgImage: "https://st5.depositphotos.com/59760978/79766/i/450/depositphotos_797669262-stock-photo-lonely-wooden-figure-sad-face.jpg",
      content: "I've grown up to be a premature baby, my mother's genetics are of the less dominant height status, I've experienced encounters where I've been blatantly called out for my height, telling me about my inadequacies due to my short reach.."
    },
    {
      title: "Development",
      ...
      icon: UsersRound,
      bgImage: "https://images.unsplash.com/photo-1762345127396-ac4a970436c3?q=80&w=1204&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      content: "I've met people and know of the social norms, where a guy should be taller than most people and also telling that height showcases dominance. I've learned to make me aware that even with my short reach there were people who were fond of me, both romantically and platonically.."
    },
    {
      title: "Integration",
      ...
      icon: Heart,
      bgImage: "https://images.unsplash.com/photo-1610751399547-46ad575447cf?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      content: "I've lived throughout till now and learn that there are people with their own preferences, may it come to their romantic interests, buddies, or even their own circle of peers. It takes time and eventually everyone will encounter their own people that will accept them for who they are and support them for what they have. Physically I wasn't bothered I learned to know that my strengths are not from my physical appearances alone. I've learned to accept and embrace me for what I am capable of.."
    }
  ];
